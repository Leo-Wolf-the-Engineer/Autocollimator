...
# Kamera konfigurieren (entfernt)
# camera.PixelFormat = "BGR8"
# camera.ExposureTimeAbs = 20.0  # Belichtungszeit auf 20 Mikrosekunden setzen
...
while camera.IsGrabbing():
    ...
    if grabResult.GrabSucceeded():
        ...
        # Aktuellen Frame und Intensitätsverteilungen plotten
        plot_current_frame(axs, frame, intensity_x, intensity_y)
